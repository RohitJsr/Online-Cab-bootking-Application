...
public class DriverServiceImpl implements DriverService {
	...
	public Driver createDriver(DriverDTO cabdto) throws DriverException {
		...
		if (cb != null)
			throw new DriverException("Number Plate already registered");
	...
	public String deleteDriver(DriverDTO driver) throws DriverException {
		...
		Driver driverDetails = dDao.findById(driver.getDriverId())
				.orElseThrow(() -> new DriverException("Driver does not exist with id : " + driver.getDriverId()));
